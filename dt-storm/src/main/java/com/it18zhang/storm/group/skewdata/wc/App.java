...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("counter-1-bolt", new CountBolt(), 3).shuffleGrouping("split-bolt").setNumTasks(3);
        builder.setBolt("counter-2-bolt", new CountBolt(), 2).fieldsGrouping("counter-1-bolt", new Fields("word")).setNumTasks(2);
